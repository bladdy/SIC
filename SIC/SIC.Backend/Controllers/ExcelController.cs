...
namespace SIC.Backend.Controllers
{
    ...
    public class ExcelController : ControllerBase
    {
                ...
                foreach (var row in rows)
                {
                    try
                    {
                        ...
                        var invitation = new Invitation
                        {
                            ...
                            Comments = row.Cell(12).GetString(),
                            LinkPersonalizado = row.Cell(13).GetString(),
        ...
        public async Task<IActionResult> GenerarExcel(int EventId)
        {
            ...
            worksheet.Cell(1, 13).Value = "Link Personalizado";
            ...
            foreach (var invitation in invitationsList)
            {
                ...
                worksheet.Cell(row, 12).Value = invitation.Comments;
                worksheet.Cell(row, 13).Value = invitation.LinkPersonalizado;
