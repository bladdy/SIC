...
function contarInvitados() {
    ...
    document.getElementById("invitados_jovenes").innerText = `Jóvenes invitados: ${jovenes}`;
    document.getElementById("invitados_menores").innerText = `Niños invitados: ${menores}`;
}
