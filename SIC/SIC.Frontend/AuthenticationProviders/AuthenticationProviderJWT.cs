...
namespace SIC.Frontend.AuthenticationProviders
{
    public class AuthenticationProviderJWT : AuthenticationStateProvider, ILoginService
    {
        ...
        {
            var jwrSecuritityTokenHandler = new JwtSecurityTokenHandler();
            var unserializedToken = jwrSecuritityTokenHandler.ReadJwtToken(token);
